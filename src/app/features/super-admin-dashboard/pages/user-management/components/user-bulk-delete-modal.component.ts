...
@Component({
  selector: 'app-user-bulk-delete-modal',
  imports: [
    CommonModule,
    TuiButton,
    TuiIcon,
        ...
        <div class="modal-content delete-modal" (click)="$event.stopPropagation()">
          ...
          <div class="modal-body">
            <div class="delete-confirmation">
              ...
              <p>This action cannot be undone. All selected users will be permanently removed from the system.</p>
            </div>
          </div>
...
export class UserBulkDeleteModalComponent {
  // Inputs
